%Project 3. Biomodeling. Human Limb Motion
...
%Fuction describing the minimum jerk movement
xt=zeros(2,length(t));
...
%This loop is used to calculate the qs, qe qnd qw qt each instance
%Algorithm: 1)Calculate the Jcross
%           2)Calculate the Qdot
%           3)Calculate the new qs, qe qnd qw
